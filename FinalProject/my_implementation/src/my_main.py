...
all_networks = ['BioGRID', 'STRING-EXP', 'InBioMap', 'GIANT-TN', 'STRING', 'BioGRID_1_1', 'BioGRID_point5_1', \
				'BioGRID_1_point5', 'STRING-EXP_1_1', 'STRING-EXP_point5_1', 'STRING-EXP_1_point5']
...
def get_mdl_dict(methods, adjmat, infmat, emdmat):
	...
	if 'SL-A-LR' in methods: mdl_dict['SL-A-LR'] = core.models.SL(adjmat)
	if 'SL-A-SVM' in methods: mdl_dict['SL-A-SVM'] = core.models.SVM(adjmat)
	if 'SL-A-RF' in methods: mdl_dict['SL-A-RF'] = core.models.RF(adjmat)
	if 'SL-E-LR' in methods: mdl_dict['SL-E-LR'] = core.models.SL(emdmat)
	if 'SL-E-SVM' in methods: mdl_dict['SL-E-SVM'] = core.models.SVM(emdmat)
	if 'SL-E-RF' in methods: mdl_dict['SL-E-RF'] = core.models.RF(emdmat)
	if 'LP-I' in methods: mdl_dict['LP-I'] = core.models.LP(infmat)
	if 'LP-I25' in methods: mdl_dict['LP-I25'] = core.models.LP(core.graph.Influence.from_wugraph(adjmat, 0.25))
	if 'LP-I50' in methods: mdl_dict['LP-I50'] = core.models.LP(core.graph.Influence.from_wugraph(adjmat, 0.5))
